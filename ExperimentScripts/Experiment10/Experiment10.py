...
L2 regularisation in surface factor model based on combined point and game level information. 2 factors and handpicked
initialisation. For standard recency weighting function (half life 240 days). No regularisation. Runs 4 models across
a pool of 25 processes.
...
print('starting')
# Output files
output_file1 = "../../Outputs/Experiment10/PointGameSurfaceFactor_2Factors_HandPickedInit_Reg0_000005.csv"
output_file2 = "../../Outputs/Experiment10/PointGameSurfaceFactor_2Factors_HandPickedInit_Reg0_00001.csv"
output_file3 = "../../Outputs/Experiment10/PointGameSurfaceFactor_2Factors_HandPickedInit_Reg0_00002.csv"
output_file4 = "../../Outputs/Experiment10/PointGameSurfaceFactor_2Factors_HandPickedInit_Reg0_00003.csv"
...
def worker(q_in, q_out1, q_out2, q_out3, q_out4):
    ...
    """
    model1 = models.PointGameSurfaceFactorModel(optimiser=optimisers.SurfaceFactorModelGradient(num_factors=2,reg = 0.000005, surf_reg= 0.000005, hand_pick_init=True),repeats=0)
    model2 = models.PointGameSurfaceFactorModel(optimiser=optimisers.SurfaceFactorModelGradient(num_factors=2,reg = 0.00001, surf_reg= 0.00001,hand_pick_init=True),repeats=0)
    model3 = models.PointGameSurfaceFactorModel(optimiser=optimisers.SurfaceFactorModelGradient(num_factors=2,reg = 0.00002, surf_reg= 0.00002,hand_pick_init=True),repeats=0)
    model4 = models.PointGameSurfaceFactorModel(optimiser=optimisers.SurfaceFactorModelGradient(num_factors=2,reg = 0.00003, surf_reg= 0.00003,hand_pick_init=True),repeats=0)
    while 1:
        try:
