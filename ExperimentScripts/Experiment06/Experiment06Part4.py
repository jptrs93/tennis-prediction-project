...
Joint optimisation Bradley-Terry time series model with drift of 0.9 and prior of 1. Runs the last quarter of the
...
if __name__ == "__main__":
    ...
    # Set model 3/4 of the way through evaluation
    provider_model.skip_to(1350)
    ...
    for i in range(50):
        try:
            output_lines = q_out.get(block=True, timeout=300)  # If idle for 5 minutes assume done
            out.append_csv_rows(output_lines, output_file)
        except Queue.Empty:
            break
