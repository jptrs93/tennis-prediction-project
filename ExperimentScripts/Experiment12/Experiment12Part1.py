...
Point Game multiple factor model with 3 factors per player. 5 repeats for each optimisation
...
# Output file
output_file = "../../Outputs/Experiment12/PointGameBradleyTerry_3Factors_reg0_000001.csv"
...
def worker(q_in, q_out):
    ...
    """
    model = models.PointGameBradleyTerryModel(optimiser=optimisers.BradleyMultipleFactorGradient(num_factors=1, reg = 0.000001))
